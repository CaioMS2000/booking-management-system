...
import type { DeleteAdminUseCase } from '@/application/use-cases/delete-admin-use-case'
import type { GetAdminUseCase } from '@/application/use-cases/get-admin-use-case'
import type { UpdateAdminUseCase } from '@/application/use-cases/update-admin-use-case'
